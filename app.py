...
.step-card.active::before { background: #10b981; }
...
def step_card(num: str, title: str, state: str, desc: str = ""):
    ...
    <div class="step-card {card_cls}">
        ...
        {"<div style='font-size:0.82rem;color:#7ba876;margin-top:0.3rem;'>"+desc+"</div>" if desc else ""}
    </div>
    """, unsafe_allow_html=True)
...
with col_input:
    ...
    <div style="display:flex;gap:0.5rem;flex-wrap:wrap;margin-bottom:1.5rem;">
        <span style="font-family:'DM Mono',monospace;font-size:0.68rem;color:#738f73;letter-spacing:0.1em;">TRY →</span>
    """, unsafe_allow_html=True)
